...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h3>In time<a href="adt.jsp" id="b"><button class="b">Back</button></a></h3>
            </div>
            <!-- <div class="col-md-4">
...
String data;
data = "select * from in_time";
rs = stmt.executeQuery(data);

if (query != null) {
    data = "select * from in_time where reg_num = '"+query+"'";
    rs = stmt.executeQuery(data);
}
while (rs.next()) {
%>
<tr>
    ...
    <td><a href='reject3.jsp?d=<%=rs.getString("reg_num")%>'>reject</a></td>
</tr>
<%
}
if (rs != null) {
