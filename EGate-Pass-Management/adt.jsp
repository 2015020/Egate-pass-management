...
.hicon:nth-child(1):after{
    ...
    top: 7px;
    transform: scale(0.5);
    box-shadow: 0 0 0 0 rgb(240, 2, 2);
...
@keyframes pulse-red {
    0% {
        ...
        box-shadow: 0 0 0 0 rgba(237, 22, 22, 0.7);
    }
...
<section>
    ...
    <div id="myd">
        ...
        <ul class="nav">
            ...
            <li><a href="accept1.jsp"><i class="fa fa-smile-o"></i>accepted(EXIT)</a></li>
            <li><a href="reject1.jsp"><i class="fa fa-frown-o"></i> rejected(EXIT)</a></li>
            <li><a href="accept2.jsp"><i class="fa fa-smile-o"></i>accepted</a></li>
            <li><a href="reject2.jsp"><i class="fa fa-frown-o"></i> rejected</a></li>
    ...
    <div class="main">
		...
		<div class="col-div-3">
          ...
          try
          {
              ...
              Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gatepass","root","");     
              Statement st=con.createStatement();
              String strQuery = "SELECT COUNT(*) FROM exitpass";
              ResultSet rs = st.executeQuery(strQuery);
          
              String Countrow="";
                while(rs.next()){
                Countrow = rs.getString(1);
                out.println("Total_out:" +Countrow);
                 } 
              }
          catch (Exception e){
              e.printStackTrace();
            ...
            %><br><span>Out</span></h4>
				<i class="fa fa-sign-out box-icon"></i>
			</div>
		</div>
		<div class="col-div-3">
			<div class="box">
		...
		<div class="col-div-3">
          ...
          try
          {
              ...
              Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gatepass","root","");     
              Statement st=con.createStatement();
              String strQuery = "SELECT COUNT(*) FROM reject";
              ResultSet rs = st.executeQuery(strQuery);
          
              String Countrow="";
                while(rs.next()){
                Countrow = rs.getString(1);
                out.println("reject: " +Countrow);
                 } 
              }
          catch (Exception e){
              e.printStackTrace();
            }
            %><br/><span>rejected</span></h4>
