...
height: 900px;
width: 800px;
background-image: linear-gradient(#f34f4f, #f90b0b);
top: 50%;
left: 50%;
position: absolute;
...
font-size: 25px;
font-weight: bolder;
text-shadow: 5px 5px 10px rgb(52, 50, 50);
}
...
border-radius: 25px;
padding-top: 0.5px;
background-image: linear-gradient(#f13232, #f70606);
}
...
<body>
	...
	<P style="margin-left:40% ; color: #0b0101;">FILL THIS!</p></br></br>
		...
		<div class="card-number">
			<label style="margin-left:30% ;">DEPRT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<input
			 type="text" name="Department"  class="card-number-field"/>
		 </div>
...
<%
    ...
    if(a!=null && b!=null && c!=null && d!=null && e!=null && f!=null){
		...
		stmt = con.prepareStatement("insert into in_time (user, date, in_time, reg_num, phone_num, Department) values (?, ?, ?, ?, ?, ?);");
        stmt.setString(1,a);
        stmt.setString(2,b);
        stmt.setString(3,c);
        stmt.setString(4,d);
