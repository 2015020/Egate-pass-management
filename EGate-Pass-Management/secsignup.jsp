      ...
      <div class="login-form">
		...
		<form action="">
			<div class="sign-up-htm">
				...
				<div class="group">
				  <label for="pass" class="label">security_id</label>
				  <input id="pass" type="text"  name="security_id" class="input">
				</div>
				<div class="group">
...
<%
	...
	String b = request.getParameter("security_id");
    ...
    if(a!=null && b!=null && c!=null && d!=null && e!=null ){
        ...
        stmt = con.prepareStatement("insert into securitylog(username, security_id, password, confirm_password, email_id) values (?, ?, ?, ?, ?)");
        stmt.setString(1,a);
        stmt.setString(2,b);
        stmt.setString(3,c);
        stmt.setString(4,d);
